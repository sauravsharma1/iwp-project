...
<footer class="footer">
  <div class="footer-left">
    ...
    <p>
      ...
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. NewsBook
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make NewsBook your platform to
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved by &copy; NewsBook <?php echo date("Y")?></p>
      <h4>Made By-Saurav, Chirag, Aditya</h4>
  </div>
</footer>
